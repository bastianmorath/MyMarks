...
-(void)addConstraints{
    float height = [MMFactory heightOfRow]-5;
...
- (void)setupFloatLabel
{
    ...
    // colors
    _floatLabelPassiveColor = [UIColor colorWithRed:128/255.0f green:205/255.0f blue:159/255.0f alpha:1];
    _floatLabelActiveColor = [UIColor colorWithRed:157/255.0f green:229/255.0f blue:131/255.0f alpha:1];
